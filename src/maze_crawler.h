...
#define HALF_SCREEN_WIDTH         72 // (SCREEN_WIDTH / 2)
#define HALF_SCREEN_HEIGHT        72 // (SCREEN_HEIGHT / 2 - STATUS_BAR_HEIGHT * 0.75)
...
#define SCROLL_HEIGHT_OFFSET      10 // Ensures descenders (i.e., gjpqy) are fully visible.
